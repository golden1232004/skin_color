...
totalSkinHistogram_YCb = zeros(2^BIT_PER_CHANNEL-1,MAX_CBCR); %所有皮肤图片的直方图
totalSkinHistogram_YCr = zeros(2^BIT_PER_CHANNEL-1,MAX_CBCR);
totalNSkinHistogram_YCb = zeros(2^BIT_PER_CHANNEL-1,MAX_CBCR); %所有非皮肤图片直方图
                    ...
                    if strcmp(skinImageName(1:skinImageMatchRange),maskImageName(1:maskImageMatchRange))  %判断皮肤图片和mask图片的名字是否相同
                        ...
                        if s==3;
                            ...
                            [totalSkinHistogram_YCb,totalSkinHistogram_YCr,totalNSkinHistogram_YCb,totalNSkinHistogram_YCr]=...
                                GetHistogramOfYCbCr_Y( YCbCrSkinImage,maskImage,totalSkinHistogram_YCb,totalSkinHistogram_YCr,totalNSkinHistogram_YCb,totalNSkinHistogram_YCr );    %一幅图片的直方图
...
toc;
%计算类条件概率密度分布
skinPDDofYCb = totalSkinHistogram_YCb / totalSkinPixel_YCb;  % skinProbabilityDensityDitribution：皮肤概率密度分布
